...
import { Box, Plus, Edit2, Trash2, X, Save, AlertTriangle } from 'lucide-react';
      ...
      <>
         ...
         {editingProject && createPortal(
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
               {/* Backdrop */}
               <div className="absolute inset-0 bg-neutral-900/60 backdrop-blur-sm transition-opacity" onClick={() => setEditingProject(null)} />
               
               {/* Modal Content */}
               <div className="relative bg-white dark:bg-neutral-900 w-full max-w-lg rounded-3xl shadow-2xl p-8 border border-gray-200 dark:border-neutral-700 z-10" onClick={e => e.stopPropagation()}>
