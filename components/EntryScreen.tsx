...
export const EntryScreen: React.FC<EntryScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden bg-graphite-950 text-white font-sans">
      
      {/* New Circuit Board Background */}
      <CircuitBackground opacity={0.2} />
      
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-graphite-950/80 to-graphite-950 pointer-events-none"></div>
      ...
      {/* --- Main Stage --- */}
      <div className={`relative z-20 flex flex-col items-center justify-center h-full w-full transition-all duration-700 ease-in-out ${success ? 'scale-110 opacity-0 blur-lg' : 'scale-100 opacity-100'}`}>
         
         <div className="relative w-full max-w-md px-6">
            
            {/* The Monolith Card */}
            <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 md:p-10 shadow-2xl relative overflow-hidden group">
               ...
               <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-graphite-800 to-black border border-white/10 mb-6 shadow-neon relative group-hover:scale-105 transition-transform duration-500">
               ...
               <form onSubmit={handleLogin} className="space-y-5">
                  <div className="space-y-1">
                     ...
                     <div className="relative group">
                        ...
                        <input 
                           ...
                           value={email}
                           readOnly
                           className="block w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-sm text-gray-300 placeholder-gray-600 focus:ring-1 focus:ring-plasma-500 focus:border-plasma-500 focus:bg-white/10 transition-all outline-none cursor-not-allowed"
                        />
                  ...
                  <div className="space-y-1">
                     ...
                     <div className="relative group">
                        ...
                        <input 
                           ...
                           value={password}
                           readOnly
                           className="block w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-sm text-gray-300 placeholder-gray-600 focus:ring-1 focus:ring-plasma-500 focus:border-plasma-500 focus:bg-white/10 transition-all outline-none cursor-not-allowed font-mono tracking-widest"
                        />
                     </div>
                  </div>
                  ...
                  <button 
                     ...
                     className={`
                        ...
                        ${isAuthenticating ? 'bg-plasma-900/50 cursor-wait' : 'bg-white text-black hover:scale-[1.02] shadow-neon cursor-pointer'}
                     `}
                  >
